...
The source for old versions (1.x.x, v7 and earlier) of the mods is available in [`legacy-framework`](TODO: link) branch. As long as the old modloader itself continues to work for you, these should too. I'll probably keep updating the legacy Scoreboard characters with new characters and elfins for some time.
